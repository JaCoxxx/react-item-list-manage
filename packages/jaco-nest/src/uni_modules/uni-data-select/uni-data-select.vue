          ...
          <template v-else>
            ...
            <view v-else class="uni-select__input-text uni-select__input-placeholder" :class="'align-'+align">{{typePlaceholder}}</view>
					...
					<view key="clear-button" v-if="!hideRight && shouldShowClear && clear && !disabled" @click.stop="clearVal">
						<uni-icons type="clear" color="var(--jn-color-text-tertiary)" size="24" />
					</view>
					<view key="arrow-button" v-else-if="!hideRight">
						<uni-icons :type="showSelector? 'top' : 'bottom'" size="14" color="var(--jn-color-text-tertiary)" />
					</view>
				</view>
...
<style lang="scss">
	$uni-base-color: var(--jn-color-text-secondary) !default;
	$uni-main-color: var(--jn-color-text-primary) !default;
	$uni-secondary-color: var(--jn-color-text-tertiary) !default;
	$uni-border-3: var(--jn-color-border);
  $uni-primary: var(--jn-color-primary) !default;
	$uni-success: var(--jn-color-success) !default;
	$uni-warning: var(--jn-color-warning) !default;
	$uni-error: var(--jn-color-danger) !default;
	$uni-info: var(--jn-color-text-tertiary) !default;
	...
	.uni-stat__actived {
		width: 100%;
		flex: 1;
		// outline: 1px solid var(--jn-color-primary);
	}
  ...
  .border-default {
	...
	.uni-select__selector {
		...
		border-radius: 6px;
		box-shadow: 0 2px 12px 0 var(--jn-color-overlay-light);
		z-index: 3;
		padding: 4px 0;
	}
	...
	.uni-popper__arrow_bottom {
		filter: drop-shadow(0 2px 12px var(--jn-color-overlay-subtle));
		top: -6px;
		left: 10%;
		margin-right: 3px;
		border-top-width: 0;
		border-bottom-color: var(--jn-color-border);
	}
	...
	.uni-popper__arrow_top {
		...
		border-top-color: var(--jn-color-border);
	}
