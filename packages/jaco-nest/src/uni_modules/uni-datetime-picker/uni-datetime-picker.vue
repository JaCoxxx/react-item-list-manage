			...
			<slot>
				<view class="uni-date-editor--x"
					...
					<view v-if="!isRange" class="uni-date-x uni-date-single">
						<uni-icons class="icon-calendar" type="calendar" color="var(--jn-color-text-tertiary)" size="22"></uni-icons>
					...
					<view v-if="showClearIcon" class="uni-date__icon-clear" @click.stop="clear">
						<uni-icons type="clear" color="var(--jn-color-text-tertiary)" size="22"></uni-icons>
					</view>
				</view>
			</slot>
		</view>
		...
		<view v-if="!isPhone" v-show="pickerVisible" ref="datePicker" class="uni-date-picker__container">
			...
			<view v-else class="uni-date-range--x" :style="pickerPositionStyle">
				...
				<view v-if="hasTime" class="popup-x-header uni-date-changed">
					...
					<uni-icons type="arrowthinright" color="var(--jn-color-text-tertiary)" style="line-height: 40px;"></uni-icons>
				...
				<view class="popup-x-body">
					...
					<Calendar ref="right" :showMonth="false" :start-date="calendarRange.startDate"
						...
						@firstEnterCale="updateLeftCale" style="padding: 0 8px;border-left: 1px solid var(--jn-color-surface-muted);" />
				</view>
...
<style lang="scss">
	...
	.uni-date-mask--pc {
		...
		left: 0px;
		right: 0px;
		background-color: var(--jn-color-overlay);
	...
	.uni-date-changed {
		...
		border-bottom-color: var(--jn-color-surface-muted);
