<template>
	...
	<cell :keep-scroll-position="keepScrollPosition">
		...
		<view :class="{ 'uni-list-item--disabled': disabled }" :style="{'background-color':customStyle.backgroundColor}"
			...
			<uni-icons v-if="showArrow || link" :size="16" class="uni-icon-wrapper" color="var(--jn-color-border)" type="right" />
		</view>
		<!-- #ifdef APP-NVUE -->
	</cell>
	<!-- #endif -->
...
<script>
	 ...
	 * @property {Object} 	extraIcon 						扩展图标参数，格式为 {color: 'var(--jn-color-success)',size: '22',type: 'spinner'}
