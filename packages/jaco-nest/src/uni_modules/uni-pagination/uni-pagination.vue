	...
	<view class="uni-pagination">
		...
		<picker v-if="showPageSize === true || showPageSize === 'true'" class="select-picker" mode="selector"
			...
			<button type="default" size="mini" :plain="true">
				...
				<uni-icons class="select-picker-icon" type="arrowdown" size="12" color="var(--jn-color-text-tertiary)"></uni-icons>
			</button>
		</picker>
		<!-- #endif -->
		<!-- #ifndef APP-NVUE -->
		...
		<view class="uni-pagination__btn"
			...
			<template v-if="showIcon === true || showIcon === 'true'">
				<uni-icons color="var(--jn-color-text-secondary)" size="16" type="left" />
			</template>
			<template v-else>
		...
		<view class="uni-pagination__btn"
			...
			<template v-if="showIcon === true || showIcon === 'true'">
				<uni-icons color="var(--jn-color-text-secondary)" size="16" type="right" />
			</template>
			<template v-else>
...
<style lang="scss" scoped>
	...
	.uni-pagination--hover {
		color: var(--jn-color-overlay-heavy);
		background-color: var(--jn-color-surface-muted);
	}
