		...
		<view ref="uni-rate" class="uni-rate">
			<view class="uni-rate__icon" :class="{'uni-cursor-not-allowed': disabled}"
				...
				<view :style="{ width: star.activeWitch.replace('%','')*size/100+'px'}" class="uni-rate__icon-on">
					<uni-icons style="text-align: left;" :color="disabled?'var(--jn-color-border)':activeColor" :size="size"
						type="star-filled" />
				</view>
				<!-- #endif -->
				<!-- #ifndef APP-NVUE -->
...
<script>
	 ...
	 * @property {String} 	color 						未选中状态的星星颜色，默认为 "var(--jn-color-text-tertiary)"
	 * @property {String} 	activeColor 				选中状态的星星颜色，默认为 "var(--jn-color-warning)"
	 * @property {String} 	disabledColor 				禁用状态的星星颜色，默认为 "var(--jn-color-text-tertiary)"
	...
	export default {
		...
		props: {
			...
			color: {
				// 星星未选中的颜色
				type: String,
				default: "var(--jn-color-text-tertiary)"
			},
			activeColor: {
				// 星星选中状态颜色
				type: String,
				default: "var(--jn-color-warning)"
			},
			disabledColor: {
				// 星星禁用状态颜色
				type: String,
