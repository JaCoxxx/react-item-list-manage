		...
		<view :style="{borderRadius:radius+'px',backgroundColor: bgColor}" class="uni-searchbar__box"
			...
			<view class="uni-searchbar__box-icon-search">
				<slot name="searchIcon">
					<uni-icons color="var(--jn-color-text-tertiary)" size="18" type="search" />
				</slot>
			</view>
			...
			<view v-if="show && (clearButton==='always'||clearButton==='auto'&&searchVal!=='') &&!readonly"
				...
				<slot name="clearIcon">
					<uni-icons color="var(--jn-color-text-tertiary)" size="20" type="clear" />
				</slot>
			</view>
		</view>
...
<script>
	...
	export default {
		...
		props: {
			...
			bgColor: {
				type: String,
				default: "var(--jn-color-surface-muted)"
			},
			textColor: {
				type: String,
				default: "var(--jn-color-text-primary)"
			},
			maxlength: {
				type: [Number, String],
				default: 100
