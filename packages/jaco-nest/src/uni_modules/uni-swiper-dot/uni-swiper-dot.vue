		...
		data() {
			return {
				dots: {
					...
					backgroundColor: 'var(--jn-color-overlay-medium)',
					border: '1px var(--jn-color-overlay-medium) solid',
					selectedBackgroundColor: 'var(--jn-color-text-primary)',
					selectedBorder: '1px var(--jn-color-overlay-opaque) solid'
				}
			}
		},
		watch: {
...
<style lang="scss" scoped>
	...
	.uni-swiper__dots-nav {
		...
		align-items: center;
		background-color: var(--jn-color-overlay-soft);
	}
