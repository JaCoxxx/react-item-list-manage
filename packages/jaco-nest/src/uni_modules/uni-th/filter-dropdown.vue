...
<style lang="scss">
	...
	.icon-select {
		...
		border-top: solid 6px var(--jn-color-border);
		border-bottom: none;
		background-color: var(--jn-color-border);
	...
	.icon-search-0 {
		border: 2px solid var(--jn-color-border);
		border-radius: 8px;
		width: 7px;
		height: 7px;
	}
	...
	.dropdown-popup {
		...
		box-shadow: 0 3px 6px -4px var(--jn-color-overlay-subtle), 0 6px 16px var(--jn-color-overlay-subtle), 0 9px 28px 8px var(--jn-color-overlay-subtle);
		min-width: 150px;
		z-index: 1000;
	}
	...
	.search-input {
		font-size: 12px;
		border: 1px solid var(--jn-color-surface-muted);
		border-radius: 3px;
		padding: 2px 5px;
		min-width: 150px;
		text-align: left;
	...
	.opera-area {
		cursor: default;
		border-top: 1px solid var(--jn-color-border);
		padding: 5px;
	}
