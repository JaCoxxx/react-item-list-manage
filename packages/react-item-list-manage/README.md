...
This app now lives in the workspace at `packages/react-item-list-manage`.
Run install and common scripts from the repository root unless you are targeting this package explicitly.
